...
project2.addEventListener("click", () => {
    ...
    projectLink.textContent = projectInformation.project2.link
})
...
project3.addEventListener("click", () => {
    ...
    projectLink.textContent = projectInformation.project3.link
})
...
project4.addEventListener("click", () => {
    ...
    projectLink.textContent = projectInformation.project4.link
})
...
project5.addEventListener("click", () => {
    ...
    projectLink.textContent = projectInformation.project5.link
})
...
project6.addEventListener("click", () => {
    ...
    projectLink.textContent = projectInformation.project6.link
})
...
project7.addEventListener("click", () => {
    ...
    projectLink.textContent = projectInformation.project7.link
})
...
project8.addEventListener("click", () => {
    ...
    projectLink.textContent = projectInformation.project8.link
})
...
project9.addEventListener("click", () => {
    ...
    projectLink.textContent = projectInformation.project9.link
})
...
project10.addEventListener("click", () => {
    ...
    projectLink.textContent = projectInformation.project10.link
})
